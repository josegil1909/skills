...
## AFY Naming Conventions

### Go

| Type | Convention | Example |
|------|-----------|---------|
| Public struct | PascalCase | `Service`, `Document` |
| Private struct | camelCase | `syncResourceState` |
| Interface | PascalCase + action | `ProductRepository`, `SalesUseCase` |
| Constructor | `New` + name | `NewService`, `NewSQLProductRepository` |
| Public method | PascalCase | `Save`, `Validate` |
| Private method | camelCase | `resolveRefundMode`, `computeFiscalHash` |
| Package | lowercase | `sales`, `documents`, `db_libsql` |
| File | snake_case | `service_test.go`, `sql_product_repository.go` |

### Vue / TypeScript

| Type | Convention | Example |
|------|-----------|---------|
| Component | PascalCase.vue | `PosPaymentModal.vue` |
| Composable | camelCase, `use` prefix | `usePaymentCalculation.ts` |
| Store | camelCase, `use` + `Store` | `usePosStore.ts` |
| Interface/Type | PascalCase | `CartLine`, `PaymentMethod` |
| Helper | camelCase | `formatDualAmount` |
| Global constant | SCREAMING_SNAKE_CASE | `DEFAULT_VAT_RATE_BPS` |
